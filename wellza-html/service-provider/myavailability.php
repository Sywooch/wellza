...
<html>
    <head>
        ...
        <style type="text/css" media="screen">
            ...
            .schedule_calender .left{ padding: 0px;}
            .schedule_calender .right{ border-top: none;}
            .dhx_cal_data { border-top: 1px solid #ddd;}
            .schedule_calender .dhx_mini_calendar{ border: none; box-shadow: none !important;}
            .schedule_calender .calendar .dhx_year_month{font-family: 'ITCAvantGardeStd' !important; font-size: 25px; height: auto; line-height: 53px; padding: 0px; width: 358px; text-transform: uppercase; position: relative; margin: 15px auto 25px; color: #52bfb8;}
