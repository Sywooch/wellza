    ...
    <div class="side-menu-content">
        <div class="menu-list">
            <ul id="menu-content" class="menu-content list-unstyled">
                ...
                ?>
                <li class="icon profile" data-toggle="collapse" data-target="#manageprofile-menu" aria-expanded="true">
                    <a href="javascript:void(0);" id="manage_profilemodal" data-target=".manage-profile-modal" data-toggle="modal">
                        MANAGE PROFILE
                    </a>       
                </li>
                <?php
                ...
                <ul class="sub-menu list-unstyled collapse" id="manageprofile-menu" aria-expanded="true" style="">
                    ...
                    <li class=""><a href="<?php echo Yii::$app->urlManager->createUrl('provider/portfolio')?>">ADD PORTFOLIO</a></li>
                ...
                <ul class="sub-menu collapse list-unstyled" id="appointment-menu">
                    <li class=""><a href="<?php echo Yii::$app->urlManager->createUrl('provider/appointment')?>#complete-appointment">COMPLETED</a></li>
                    <li class=""><a href="<?php echo Yii::$app->urlManager->createUrl('provider/appointment')?>#upcoming-appointment">UPCOMING</a></li>
                </ul>
                <?php
                    } else {
                ?>
                ...
                <li class="icon inbox">
                    <?php
                        if(!Yii::$app->user->isGuest && Yii::$app->user->isProvider){
                    ?>
                    <a href="<?php echo Yii::$app->urlManager->createUrl('provider/inbox')?>">
                        INBOX
                    </a>
                    <?php
                        } else {
                    ?>
                    <a href="<?php echo Yii::$app->urlManager->createUrl('client/inbox')?>">
                        INBOX
                    </a>
                    <?php
                        }
                ...
                <li class="icon favourite">
                    <a href="<?php echo Yii::$app->urlManager->createUrl('client/favourite')?>">
                        FAVORITES
                    </a>
                </li>
