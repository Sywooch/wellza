    ...
    <div class="container apponintment-history-section">
        ...
        <div class="wellzabundle-tabs">
            ...
            <div class="tab-content">
                ...
                <input type="hidden" id="pageurl" name="pageurl" value="<?php echo Yii::$app->urlManager->createUrl('provider/appointment') ?>">
            </div>
        </div>
    </div>    
    <?php
...
$this->registerCssFile('@web/css/provider/appointment.css');
$this->registerJsFile('@web/js/provider/appointment.js');
