...
if (!empty($returndata)) {
    ...
    //$profile_image = !empty($returndata['profile_image']) ? '../'.$returndata['profile_image'] : $site_url . '/images/default-profile.png';
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="form-control experience"><?= $experience_in_year ?> </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="edit_profile" style="display: none;">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <?=
                        $form->field($model, 'experience_in_year', [
                            'template' => "{label}\n<div class='form-control'><div class='select-year'>{input}<div class='year_label'>Year</div></div>\n",
                            'labelOptions' => [ 'class' => 'control-label']
                        ])->dropDownList($yop, ['class' => '', 'data-size' => 5, 'id' => 'experience_in_year'])->label('Year of Experience:');
                        ?>
                        <?=
                        $form->field($model, 'experience_in_month', [
                            'template' => "{label}\n<div class='select-month'>{input}<div class='month_label'>Month</div></div></div>\n{hint}\n{error}",
                            'labelOptions' => [ 'class' => 'control-label']
                        ])->dropDownList($month, ['class' => '', 'data-size' => 5])->label(false);
                        ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<?php
$this->registerCssFile('@web/css/provider/myprofile.css');
//$this->registerJsFile('@web/js/cropper.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile('@web/js/myprofile.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
