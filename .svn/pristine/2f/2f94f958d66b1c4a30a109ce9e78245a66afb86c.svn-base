$(document).ready(function () {
    ...
    $('#select-time-slider').owlCarousel({
        ...
        navText: ["<img src="+site_url+"resource/images/left-arrow.png>", "<img src="+site_url+"resource/images/right-arrow.png>"]
...
$("#select_location").click(function(e){
   ...
   if(appointment_minutes =='' || appointment_date =='' || appointment_date =='' || appointment_time == '') {
