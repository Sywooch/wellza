 ...
 * @property User $user
 */
class BaseUserPoints extends \common\models\base\BaseUserPoints
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return UserPointsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new UserPointsQuery(get_called_class());
    }
}
