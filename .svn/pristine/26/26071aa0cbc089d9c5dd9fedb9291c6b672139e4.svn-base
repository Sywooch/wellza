...
<html>
    <head>
        <title>Wellza Terms and Conditions</title>
        <style>
            body{ margin: 0;padding: 0 15px;}
            h1 {
                color           : black;
                font-family     : ProximaNova-Semibold;
                src: url('file:///android_asset/fonts/ProximaNova-Semibold.OTF'); 
                font-size       : 23px;
    ...
    <body>
        ...
        <ul>
            ...
            <li> The standard chunk of Lorem Ipsum used? 
            ...
            <p>here are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised. </p>
            </li>
            ...
            <li> The standard Lorem Ipsum passage, used since the 1500s? 
