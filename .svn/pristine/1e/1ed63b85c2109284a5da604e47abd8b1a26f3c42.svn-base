<?php
/************************************************************************************************************************//**
 *  Controller Name: ProviderDetailController.php
 *  Created: Codian Team
 *  Description: This will manage the provider's details inlcuding portfolio images and video,customers list,appoitnment
 * 
 ***************************************************************************************************************************/
...
class ProviderDetailController extends \backend\components\Controller
{
    ...
    {   $model = new \common\models\User();
        ...
        $dataprovider_upcoming = \common\models\Appointment::getProviderApppointmentData($id, 'Upcoming', 'web');
        $dataprovider_completed = \common\models\Appointment::getProviderApppointmentData($id, 'Complete', 'web');
        
        //$id = Yii::$app->user->id;
        $portfolios = \common\models\Portfolio::getPortfolioData($id);
        return $this->render('provider-detail',['model' => $model,'data' => $data,'province' => $province,'cities' => $cities,'portfolios' => $portfolios,'upcoming' => $dataprovider_upcoming->getModels(),'completed' => $dataprovider_completed->getModels(), 'model_review_rating' => $model_review_rating]);
    }
...
/*************************************************************************************************************************************/
// EOF: ProviderDetailController.php
/*************************************************************************************************************************************/