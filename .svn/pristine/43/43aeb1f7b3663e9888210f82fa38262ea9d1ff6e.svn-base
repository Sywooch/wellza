 ...
 *  View Name: inbox.php
 *  Created: Codian Team
 *  Description: Client can chat with avaiable provider online.
 * ************************************************************************************************************************* */
            ...
            <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 right">
                <div class="chat-box">
                    ...
                    <div id="tb-message-box" class="message-box first">
                        <div class="message-box-section">
                            Choose Provider to start conversation
                        </div>
                    </div>
                </div>
                <?php
                ...
                <?php ActiveForm::end(); ?>
                <?php
                    $clientprofile_image = !empty($client_data->profile_image_thumb) ? '../'.$client_data->profile_image_thumb : $site_url . '/images/default-profile.png';         
                ?>
                <input type="hidden" id="pageurl" name="pageurl" value="<?php echo Yii::$app->urlManager->createUrl('client/inbox') ?>">
                <input type="hidden" id="currentuser_id" name="currentuser_id" value="<?php echo Yii::$app->user->id ?>">
                <input type="hidden" id="profile_imgae" name="profile_imgae" value="<?php echo $clientprofile_image ?>"> 
            </div>
        </div>
    </div>  
</main>
