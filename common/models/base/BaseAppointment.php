<?php
/* * ********************************************************************************************************************* *//**
 *  Model Name: BaseAppointment.php
 *  Created: Codian Team
...
class BaseAppointment extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(\common\models\PackageServices::className(), ['package_id' => 'package_id']);
    }
    ...
    {
        return $this->hasOne(\common\models\ReviewRating::className(), ['provided_to' => 'provider_id']);
    }
}

/* * ********************************************************************************************************************************** */
// EOF: BaseAppointment.php
/* * ********************************************************************************************************************************** */